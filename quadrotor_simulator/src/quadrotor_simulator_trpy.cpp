...
class QuadrotorSimulatorTRPY
    : public QuadrotorSimulatorBase<quadrotor_msgs::TRPYCommand, TRPYCommand>
{
 public:
...
{
  ros::init(argc, argv, "quadrotor_simulator_trpy");
