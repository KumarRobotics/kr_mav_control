...
void TRPYCmdToSnav::onInit(void)
{
  ...
  trpy_cmd_sub_ = priv_nh.subscribe("trpy_cmd", 10, &TRPYCmdToSnav::trpy_cmd_callback, this,
                        ros::TransportHints().tcpNoDelay());

  odom_sub_ = priv_nh.subscribe("odom", 10, &TRPYCmdToSnav::odom_callback,
                                this, ros::TransportHints().tcpNoDelay());

  imu_sub_ = priv_nh.subscribe("imu", 10, &TRPYCmdToSnav::imu_callback, this,
                               ros::TransportHints().tcpNoDelay());
}
