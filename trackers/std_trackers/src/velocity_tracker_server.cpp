...
private:
  ...
  typedef actionlib::SimpleActionServer<tracker_msgs::VelocityTrackerAction> ServerType;
...
void VelocityTrackerAction::Deactivate(void)
{
  if (tracker_server_->isActive()) {
    ...
    tracker_msgs::VelocityTrackerResult result;
...
quadrotor_msgs::PositionCommand::ConstPtr VelocityTrackerAction::update(const nav_msgs::Odometry::ConstPtr &msg)
{
  ...
  // Send feedback;
  tracker_msgs::VelocityTrackerFeedback feedback;
