...
public:
  ...
  void setParams(const kr_tracker_msgs::LissajousAdderGoal::ConstPtr& msg,
                 int num);
  void generatePath(nav_msgs::Path& path,
...
private:
  double lissajous_period_, ramp_time_, total_time_, ramp_s_, total_s_,
      const_time_, period_;
