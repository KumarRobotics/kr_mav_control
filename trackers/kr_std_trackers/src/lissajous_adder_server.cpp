...
bool LissajousAdderAction::Activate(const kr_mav_msgs::PositionCommand::ConstPtr &cmd)
{
...
kr_mav_msgs::PositionCommand::ConstPtr LissajousAdderAction::update(const nav_msgs::Odometry::ConstPtr &msg)
{
